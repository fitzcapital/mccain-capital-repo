...
def register(app):
    ...
    app.add_url_rule(
        "/playbook", endpoint="playbook_page", view_func=h.playbook_page, methods=["GET"]
    )
    app.add_url_rule(
        "/strategies/new",
        endpoint="strategies_new",
        view_func=h.strategies_new,
        methods=["GET", "POST"],
    )
    app.add_url_rule(
        "/strategies/edit/<int:sid>",
        endpoint="strategies_edit",
        view_func=h.strategies_edit,
        methods=["GET", "POST"],
    )
    app.add_url_rule(
        "/strategies/delete/<int:sid>",
        endpoint="strategies_delete",
