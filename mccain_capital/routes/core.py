...
def register(app):
    ...
    app.add_url_rule("/setup", endpoint="setup_page", view_func=h.setup_page, methods=["GET", "POST"])
    app.add_url_rule("/login", endpoint="login_page", view_func=h.login_page, methods=["GET", "POST"])
    ...
    app.add_url_rule("/calculator", endpoint="calculator", view_func=h.calculator, methods=["GET", "POST"])
    app.add_url_rule("/goals", endpoint="goals_tracker", view_func=h.goals_tracker, methods=["GET", "POST"])
    ...
    app.add_url_rule("/admin/restore", endpoint="restore_data", view_func=h.restore_data, methods=["GET", "POST"])
    app.add_url_rule("/payouts", endpoint="payouts_page", view_func=h.payouts_page, methods=["GET", "POST"])
