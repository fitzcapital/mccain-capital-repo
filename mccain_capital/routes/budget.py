...
def register(app):
    ...
    app.add_url_rule(
        "/api/budget/analytics", endpoint="budget_analytics", view_func=h.api_analytics
    )
    app.add_url_rule(
        "/api/budget/profile", endpoint="budget_profile", view_func=h.api_profile, methods=["POST"]
    )
    app.add_url_rule(
        "/api/budget/income", endpoint="budget_income", view_func=h.api_income, methods=["POST"]
    )
    app.add_url_rule(
    ...
    app.add_url_rule(
        "/api/budget/bill", endpoint="budget_bill", view_func=h.api_bill, methods=["POST"]
    )
    app.add_url_rule(
    ...
    app.add_url_rule(
        "/api/budget/charge", endpoint="budget_charge", view_func=h.api_charge, methods=["POST"]
    )
    app.add_url_rule(
    ...
    app.add_url_rule(
        "/api/budget/debt", endpoint="budget_debt", view_func=h.api_debt, methods=["POST"]
    )
    app.add_url_rule(
    ...
    app.add_url_rule(
        "/api/budget/goal", endpoint="budget_goal", view_func=h.api_goal, methods=["POST"]
    )
    app.add_url_rule(
