# market-pulse-scenario-ranking Specification

## Purpose

Ranked multi-level Market Pulse scenario generation, evidence gates, confluence scoring, presentation, and refresh behavior.
...
- **THEN** every execution surface remains `WAIT` and explains that
