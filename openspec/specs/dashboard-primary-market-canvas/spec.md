# Dashboard Primary Market Canvas

## Purpose

Define the dashboard chart hierarchy and market context required to read SPX location, volatility confirmation, index participation, and data readiness quickly.
