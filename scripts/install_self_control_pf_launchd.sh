...
BLOCKER="${REPO_ROOT}/scripts/self_control_pf_blocker.py"
...
OUT_LOG="${LOG_DIR}/self-control-pf.out.log"
ERR_LOG="${LOG_DIR}/self-control-pf.err.log"
...
<plist version="1.0">
<dict>
  <key>Label</key><string>com.mccain.selfcontrolpf</string>
...
launchctl enable system/com.mccain.selfcontrolpf >/dev/null 2>&1 || true
launchctl kickstart -k system/com.mccain.selfcontrolpf
